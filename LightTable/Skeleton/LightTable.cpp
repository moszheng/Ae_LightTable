	...
	PF_LayerDef		*output )
{
	...
	out_data->num_params = LIGHTTABLE_NUM_PARAMS;
	...
	PF_LayerDef		*output )
{
	...
	giP.gainF 	= params[LIGHTTABLE_GAIN]->u.fs_d.value;
	
	if (PF_WORLD_IS_DEEP(output)){
		ERR(suites.Iterate16Suite2()->iterate(	in_data,
												0,								// progress base
												linesL,							// progress final
												&params[LIGHTTABLE_INPUT]->u.ld,	// src 
	...
	const char* inHostVersion)
{
	...
	result = PF_REGISTER_EFFECT(
		...
		"LightTable", // Name
		"ADBE LightTable", // Match Name
		"SlothFellas", // Category
